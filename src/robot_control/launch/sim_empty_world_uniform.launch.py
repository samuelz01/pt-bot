...
def generate_launch_description():
    ...
    archivo_mundo = os.path.join(dir_paquete, 'worlds', 'mundo_vacio_uniforme.sdf')
    ...
    argumento_mundo = DeclareLaunchArgument(
        ...
        description='Mundo vacio con friccion uniforme para pruebas del carro mecanum',
    )
    ...
    topico_joint_state_gz = (
        '/world/mundo_vacio_uniforme/model/mecanum_bot/joint_state'
    )

    puente = Node(
        package='ros_gz_bridge',
        executable='parameter_bridge',
        name='puente_sim_empty_world_uniform',
        arguments=[
