...
def generate_launch_description():
    ...
    archivo_mundo = os.path.join(dir_paquete, 'worlds', 'nuevo_mundo.sdf')
    ...
    argumento_mundo = DeclareLaunchArgument(
        ...
        description='Mundo principal para co-simulacion ROS 2/Gazebo/Simulink',
    )
    ...
    topico_joint_state_gz = (
        '/world/nuevo_mundo/model/mecanum_bot/joint_state'
    )
